...
resource "azurerm_private_endpoint" "this_managed_dns_zone_groups" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = terraform_data.ad_creation_provisioner.id # TODO: Replace this dummy resource azurerm_resource_group.TODO with your module resource
